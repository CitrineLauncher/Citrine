...
{
    auto StringToVisibilityConverter::Convert(winrt::IInspectable const& value, winrt::TypeName const&, winrt::IInspectable const& parameter, winrt::hstring const&) -> winrt::IInspectable {
    ...
    auto StringToVisibilityConverter::ConvertBack(winrt::IInspectable const&, winrt::TypeName const&, winrt::IInspectable const&, winrt::hstring const&) -> winrt::IInspectable {
